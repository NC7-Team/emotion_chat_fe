...
import CameraModal from './CameraModal'; // CameraModal.js 불러오기
import './MainPage.css';
...
export default function Album() {
  ...
  const [isCameraModalOpen, setIsCameraModalOpen] = useState(false); // 모달 상태 추가
  ...
  return (
      <ThemeProvider theme={defaultTheme}>
        <main>
          ...
          >
            <Container maxWidth="sm">
              ...
              >
                <Button variant="contained" color="primary" onClick={openCameraModal}>
                  입장 전 사진찍기
                </Button>
              </Stack>
            </Container>
        ...
        {/* Camera Modal */}
        <CameraModal isOpen={isCameraModalOpen} closeModal={closeCameraModal} onTakePicture={() => {}} />
        {/* Footer */}
